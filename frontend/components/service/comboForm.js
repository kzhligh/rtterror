...
const ComboItem = (props)=>{
    const {item ,handleServiceCheck ,removeService , isEdit , serviceCheckList} = props
...
const EditCombo = (props)=>{
    const {editDialog,setEditDialog  ,serviceCheckListAddable,handleServiceCheck ,removeService, handleSave} = props;
    ...
    return (
        ...
        >
            ...
            <Dialog open={editDialog} fullWidth={true}  scroll="body">
                ...
                <DialogContent>
                    <Stack spacing={2}>
                        {serviceCheckListAddable && serviceCheckListAddable.map((item) => (
                            <ComboItem
                                key={item.id}
                                item={item}
...
const ComboForm =(props)=>{
    const {openDialog , handleCloseComboDialog, serviceCheckList , handleServiceCheck ,type ,setServiceCheckList} = props
    ...
    return (<div>
        <Dialog open={openDialog} fullWidth={true} maxWidth="lg" scroll="body">
            ...
            <DialogActions>
                <div className={styled.flexSpaceBetween}>
                    <Button onClick={isEdit()?handleEditSubmit: handleCreateCombo}>Submit</Button>
