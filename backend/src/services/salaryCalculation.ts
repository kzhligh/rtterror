...
class SalaryCalculationFactory
{
    static createObject(nameOfSalaryCalculation: string) : SalaryCalculation {

        if( nameOfSalaryCalculation === "TimeBasedCalculation" )
        {
            return new TimeBasedCalculation(new TimeParameter("TimeParameter",1,24,10),new SalaryRateParameter("SalaryRateParameter",1,20,14));
        }
        else if(nameOfSalaryCalculation === "SalaryBasedCalculation")
        {
            return new ServiceBasedCalculation(new FixedPriceParameter("FixedPriceParameter",1,1000,10),new NumOfServicesParameter("NumOfServicesParameter",1,1000,20));   
        }
        else {
            return new CommissionBasedCalculation(new ServiceCostParameter("ServiceCostParameter",1,1000,100),new CommissionPercentageParameter("CommissionPercentageParameter",1,1000,200));
        }
    }
}
...
//var timeBasedStrategy = new TimeBasedCalculation(new TimeParameter("TimeParameter",1,24,10),new SalaryRateParameter("SalaryRateParameter",1,20,14));
var timeBasedStrategy = SalaryCalculationFactory.createObject("TimeBasedCalculation"); 
var context = new Employee(timeBasedStrategy);
console.log("Client: Strategy is set to TimeBasedCalculation.");
context.calculateSalary();

console.log('\n');

//var serviceBasedStrategy = new ServiceBasedCalculation(new FixedPriceParameter("FixedPriceParameter",1,1000,10),new NumOfServicesParameter("NumOfServicesParameter",1,1000,20));
var serviceBasedStrategy = SalaryCalculationFactory.createObject("ServiceBasedCalculation"); 
 console.log("Client: Strategy is set to ServiceBasedCalculation.");
 context.setStrategy(serviceBasedStrategy);
 context.calculateSalary();

console.log('\n');

//var commissionBasedStrategy = new CommissionBasedCalculation(new ServiceCostParameter("ServiceCostParameter",1,1000,100),new CommissionPercentageParameter("CommissionPercentageParameter",1,1000,200));
var commissionBasedStrategy = SalaryCalculationFactory.createObject("CommissionBasedCalculation"); 
console.log("Client: Strategy is set to CommissionBasedCalculation.");
context.setStrategy(commissionBasedStrategy);
context.calculateSalary();
